import { Dr as ViewEncapsulation, El as ɵɵdefineInjector, En as ElementRef, In as Input, Ta as ɵɵcontentQuery, Tc as InjectionToken, Ui as setClassMetadata, Yo as ɵɵloadQuery, _s as ɵɵqueryRefresh, a as ContentChildren, cn as Component, do as ɵɵdomElementStart, eo as ɵɵdefineComponent, is as ɵɵprojectionDef, la as ɵɵProvidersFeature, no as ɵɵdefineNgModule, ol as inject, qn as NgModule, rs as ɵɵprojection, to as ɵɵdefineDirective, uo as ɵɵdomElementEnd, va as ɵɵattribute, wn as Directive } from "./core-C9kAS_bR.js";
import { x as startWith } from "./esm5-ChK3bs0s.js";
import { i as Directionality, t as BidiModule } from "./bidi-41Nsv-HD.js";
//#region node_modules/@angular/material/fesm2022/_public-api-chunk.mjs
var TileCoordinator = class {
	...
	_findMatchingGap(tileCols) {
		if (tileCols > this.tracker.length) throw Error(`mat-grid-list: tile with colspan ${tileCols} is wider than grid with cols="${this.tracker.length}".`);
		let gapStartIndex = -1;
		let gapEndIndex = -1;
		do {
	...
	_nextRow() {
		this.columnIndex = 0;
		this.rowIndex++;
		for (let i = 0; i < this.tracker.length; i++) this.tracker[i] = Math.max(0, this.tracker[i] - 1);
	}
	_findGapEndIndex(gapStartIndex) {
		for (let i = gapStartIndex + 1; i < this.tracker.length; i++) if (this.tracker[i] != 0) return i;
		return this.tracker.length;
	}
	_markTilePosition(start, tile) {
		for (let i = 0; i < tile.colspan; i++) this.tracker[start + i] = tile.rowspan;
	}
};
...
//#endregion
//#region node_modules/@angular/material/fesm2022/grid-list.mjs
var _c0 = ["*"];
var _c1 = [
	[[
		"",
...
var MatGridTile = class MatGridTile {
	...
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		hostBindings: function MatGridTile_HostBindings(rf, ctx) {
			if (rf & 2) ɵɵattribute("rowspan", ctx.rowspan)("colspan", ctx.colspan);
		},
		inputs: {
			rowspan: "rowspan",
			colspan: "colspan"
...
var MatGridTileText = class MatGridTileText {
	_element = inject(ElementRef);
	_lines;
	ngAfterContentInit() {
	...
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		contentQueries: function MatGridTileText_ContentQueries(rf, ctx, dirIndex) {
			if (rf & 1) ɵɵcontentQuery(dirIndex, MatLine, 5);
			if (rf & 2) {
				let _t;
...
var MatGridAvatarCssMatStyler = class MatGridAvatarCssMatStyler {
...
var MatGridTileHeaderCssMatStyler = class MatGridTileHeaderCssMatStyler {
...
var MatGridTileFooterCssMatStyler = class MatGridTileFooterCssMatStyler {
...
var FixedTileStyler = class extends TileStyler {
	...
	init(gutterSize, tracker, cols, direction) {
		...
		if (!cssCalcAllowedValue.test(this.fixedRowHeight) && (typeof ngDevMode === "undefined" || ngDevMode)) throw Error(`Invalid value "${this.fixedRowHeight}" set as rowHeight.`);
	}
	...
	reset(list) {
		...
		if (list._tiles) list._tiles.forEach((tile) => {
...
var RatioTileStyler = class extends TileStyler {
	...
	_parseRatio(value) {
		...
		if (ratioParts.length !== 2 && (typeof ngDevMode === "undefined" || ngDevMode)) throw Error(`mat-grid-list: invalid ratio given for row-height: "${value}"`);
...
var MatGridList = class MatGridList {
	_element = inject(ElementRef);
	...
	_checkCols() {
		if (!this.cols && (typeof ngDevMode === "undefined" || ngDevMode)) throw Error("mat-grid-list: must pass in number of columns. Example: <mat-grid-list cols=\"3\">");
	}
	_checkRowHeight() {
		if (!this._rowHeight) this._setTileStyler("1:1");
	}
	_setTileStyler(rowHeight) {
		if (this._tileStyler) this._tileStyler.reset(this);
		if (rowHeight === MAT_FIT_MODE) this._tileStyler = new FitTileStyler();
		else if (rowHeight && rowHeight.indexOf(":") > -1) this._tileStyler = new RatioTileStyler(rowHeight);
		else this._tileStyler = new FixedTileStyler(rowHeight);
	}
	_layoutTiles() {
		if (!this._tileCoordinator) this._tileCoordinator = new TileCoordinator();
	...
	_setListStyle(style) {
		if (style) this._element.nativeElement.style[style[0]] = style[1];
	}
	...
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		contentQueries: function MatGridList_ContentQueries(rf, ctx, dirIndex) {
			if (rf & 1) ɵɵcontentQuery(dirIndex, MatGridTile, 5);
			if (rf & 2) {
				let _t;
		...
		hostBindings: function MatGridList_HostBindings(rf, ctx) {
			if (rf & 2) ɵɵattribute("cols", ctx.cols);
		},
		inputs: {
			cols: "cols",
...
var MatGridListModule = class MatGridListModule {
